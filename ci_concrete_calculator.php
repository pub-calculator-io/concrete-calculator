...
Version: 1.0.0
Author: Concrete Calculator / www.calculator.io
...
function display_calcio_ci_concrete_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_concrete_calculator', 'display_calcio_ci_concrete_calculator' );